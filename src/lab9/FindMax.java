...
public class FindMax {
	...
	class MaxThread implements Runnable {
		...
		public MaxThread(int begin, int end) {
			this.begin = begin;
			this.end = end;
		}
	...
	public void printMax() {
		...
		MaxThread part1 = new MaxThread(0, 29);
		MaxThread part2 = new MaxThread(30, 59);
		MaxThread part3 = new MaxThread(60, 89);
		...
		int max = Math.max(Math.max(part1.getMax(), part2.getMax()), part3.getMax());
